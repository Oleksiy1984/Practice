...
public class MyListImpl implements MyList, ListIterable {
	...
	private class IteratorImpl implements Iterator<Object> {
		...
		/**
		 * Get method for cursor.
		 * @return index of next element to return.
		 */
		...
		/**
		 * Set method for cursor.
		 * @param curs the parameter.
		 */
		public void setCursor(final int curs) {
			this.cursor = curs;
		}

		/**
		 * Get method for lastReturned.
		 * @return index of last element returned; -1 if no such
		 */
		...
		/**
		 * Set method for lastReturned.
		 * @param lastRet the parameter.
		 */
		public void setLastReturned(final int lastRet) {
			this.lastReturned = lastRet;
		}
	...
	private class ListIteratorImpl extends IteratorImpl implements ListIterator {
		...
		public void set(final Object e) {
			if (getLastReturned() < 0) {
				throw new IllegalStateException();
			}

			try {
				elementData[getLastReturned()] = e;
			} catch (IndexOutOfBoundsException ex) {
				throw new ConcurrentModificationException();
			}
		}
